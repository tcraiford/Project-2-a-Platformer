...
function Antiturbo(pos) {
  this.basePos = this.pos = pos.plus(new Vector(0.2, -0.1));
  this.size = new Vector (0.8, 0.9);
  this.wobble = Math.random() * Math.PI * 2;
}
Antiturbo.prototype.type = "antiturbo";
...
Bird.prototype.act = function(step) {
  this.wobble += step * flySpeed * flyDist;
  var flyPos = Math.sin(this.wobble) * flyDist;
  this.pos = this.basePos.plus(new Vector(flyPos, 0));
};
...
Antiturbo.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
}
